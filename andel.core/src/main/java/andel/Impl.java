...
public class Impl {
  ...
  public static class IntervalsImpl<T> implements Intervals<T> {
    ...
    public IntervalsImpl(int maxChildren, Node openRoot, Node closedRoot, IntMap<Long> parentsMap, long nextId) {
      ...
      @Override
      public Intervals<T> addIntervals(Iterable<Interval<T>> intervals) {
          return Impl.insertAll(this, intervals);
      }
  ...
  public static <T> IntervalsImpl<T> insertAll(IntervalsImpl<T> tree, Iterable<Interval<T>> intervals) {
